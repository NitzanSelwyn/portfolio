        ...
        <section className='flex flex-dir-col'>
          ...
          <div className='flex flex-dir-col item-center'>
            ...
            <div className='flex flex-dir-row justify-con-center col-gap-7'>
              ...
              <div className='flex flex-dir-row item-center col-gab-2'>
                <SVGWrapper isDarkMode={isDarkMode}>
              ...
              <a className='flex flex-dir-row item-center col-gab-2' href='https://www.linkedin.com/in/nitzanselwyn/' target='_blank'>
                <SVGWrapper isDarkMode={isDarkMode}>
                  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" class="h-5 w-5 text-foreground/75">
                    <path
              ...
              <a className='flex flex-dir-row item-center col-gab-2' href='https://github.com/nitzanselwyn/' target='_blank'>
                <SVGWrapper isDarkMode={isDarkMode}>
                  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 22 22" class="h-7 w-6">
                    <path
